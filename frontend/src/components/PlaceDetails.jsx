...
const PlaceDetails = () => {
	...
	const handleBooking = async () => {
		if (!checkIn || !checkOut) {
			toast.error(<h1 className="font-serif">Please select both Dates</h1>);
			return;
		}
								...
								<div className="border rounded-lg p-2 mb-4">
									...
									<div className="flex justify-between items-center mt-4">
										...
										<div className="flex items-center space-x-2">
											<button
												onClick={() =>
													handleGuestsChange("children", "decrease")
												}
												className="p-1 rounded-full bg-gray-200 hover:bg-gray-300 transition duration-300"
											>
												<Remove fontSize="small" />
											...
											<button
												onClick={() =>
													handleGuestsChange("children", "increase")
												}
												className="p-1 rounded-full bg-gray-200 hover:bg-gray-300 transition duration-300"
											>
												<Add fontSize="small" />
					...
					<div className="space-y-8 font-serif">
						<div>
							...
							<p className="leading-relaxed text-justify">
								...
								Asperiores distinctio non similique architecto perspiciatis
								quos, molestias minus eius maiores. Corporis non ipsam
								...
								sapiente molestias voluptatibus rerum iste et. Sit pariatur modi
								vel ut odit reiciendis quam veritatis, laudantium nemo animi,
								facere similique labore! Beatae deserunt quam sapiente odit
								laboriosam nemo eveniet, tenetur eaque dignissimos quia
								doloremque explicabo soluta. Excepturi blanditiis voluptate
								magni corporis laudantium quibusdam at velit cupiditate adipisci
								libero ipsum, reiciendis aut impedit, perspiciatis autem
								molestias. Placeat odit voluptatem suscipit. Perferendis, dolor
								reiciendis quidem explicabo odio deleniti! Odio perferendis,
								animi mollitia esse ipsa quasi modi omnis praesentium
								repudiandae sunt temporibus soluta beatae quis vitae, officiis
								non ut cupiditate, voluptas quisquam in alias deserunt! Vel
								omnis quam perferendis! Sapiente ea totam enim asperiores hic
								officiis aperiam nesciunt, temporibus veritatis eius dolore
								magnam reprehenderit, illo natus nobis dicta? Facere autem
								maxime hic quae deserunt incidunt nostrum suscipit, rem ut.
